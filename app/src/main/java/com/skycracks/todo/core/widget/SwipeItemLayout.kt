...
class SwipeItemLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : ViewGroup(context, attrs) {
    ...
    fun open() {
        if (mScrollOffset != -mMaxScrollOffset) {
            ...
            //当前正在向右滑，abort/*&& !mScrollRunnable.mScrollToLeft*/)
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        var lp = mMainView!!.layoutParams as ViewGroup.MarginLayoutParams
    ...
    companion object {
        ...
        private val sInterpolator = Interpolator { t ->
            var interpolator = t
            interpolator -= 1.0f
            (Math.pow(interpolator.toDouble(), 5.0)+ 1.0).toFloat()
        }
